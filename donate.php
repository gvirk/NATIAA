...
<head>
    ...
    <title>The New Amsterdam Technical Institute Alumni Association (NATIAA)</title>
 ...
 <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll logo" href="index.html"></a>
            </div>
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="ministry.html">Ministry Message</a></li>
            <li role="separator" class="divider"></li>
		...
		<li><a href="#">Videos</a></li>
            <li role="separator" class="divider"></li>
		<li><a href="#">Datasheets &amp; Brochures</a></li>
            <li role="separator" class="divider"></li>
...
<section id="contact">
     ...
     <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <span class="copyright">Copyright &copy; NATIAA 2016</span>
                </div>
                <div class="col-md-4">
